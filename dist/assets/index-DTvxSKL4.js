...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function fa(){return new un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:es(),fragmentShader:`
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function pa(){return new un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:es(),fragmentShader:`
...
#define LOW_PRECISION`),e}function hf(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ia?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===yo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===qt&&(e="SHADOWMAP_TYPE_VSM"),e}function df(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Qn:case ei:e="ENVMAP_TYPE_CUBE";break;case er:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ff(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ei:e="ENVMAP_MODE_REFRACTION";break}return e}function pf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Na:e="ENVMAP_BLENDING_MULTIPLY";break;case jo:e="ENVMAP_BLENDING_MIX";break;case Ko:e="ENVMAP_BLENDING_ADD";break}return e}function mf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function _f(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=hf(t),c=df(t),u=ff(t),f=pf(t),p=mf(t),m=t.isWebGL2?"":tf(t),v=nf(t),M=rf(s),d=r.createProgram();let h,R,E=t.glslVersion?"#version "+t.glslVersion+`
